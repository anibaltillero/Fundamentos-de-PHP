...
//* ----------------------------------------------------------------------------
define('TITULO', 'Capitulo 02: Matrices Funciones');
?>
        ...
        <div class="col col-md-12" >
            ...
            <div class="container">           
                <section id="minimal-statistics">
                    ...
                    <?php
                    Arreglos::setAsignar(Cadenas::$arrEstadoCivil);
                    Arreglos::getEstructura();
                    Arreglos::getMostrar();



                    echo ' <br><br>INVERTIR VALOR POR NOMBRE: Array_Flip() <br><br>';
                    Arreglos::setflip();
                    Arreglos::getMostrar();


                    echo '<br><br>FRECUENCIAS CON: ARRAY_COUNT_VALUE()  <br><br>';

                    $arreglo = array('Hombre', 'Mujer', 'Hombre', 'Mujer', 'Mujer');

                    Arreglos::setAsignar($arreglo);
                    Arreglos::setCountValue();
                    Arreglos::getMostrar();
                    ?>  
                </section>
            </div>
